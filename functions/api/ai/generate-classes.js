...
- ESTILO DE REDACCION (CRITICO): escribe como redactaria un educador diferencial experimentado, en lenguaje NATURAL y fluido: oraciones completas, variadas y conectadas entre si, con verbos concretos y descripciones que cualquier docente o apoderado pueda entender. PROHIBIDO el tono de plantilla: no empieces todas las clases con la misma formula (ej. "Se trabajara...", "El estudiante debera..."), no encadenes frases telegraficas, no repitas muletillas. Los terminos tecnicos (DUA, andamiaje, metacognicion) se usan solo cuando aportan precision, integrados con naturalidad en la oracion, nunca como adorno. Una clase bien redactada se lee como la descripcion real de lo que pasara en el aula, no como un formulario rellenado.${ctx.generoDocente ? `
